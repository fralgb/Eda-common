...
public enum CountryCode
{
    ...
    /**
     * Find the CountryCode by matching against the country code info,
     * it's way slower than getByCode()
    ...
    public static CountryCode getMatch(String value)
    {
        ...
        for (CountryCode enumDef : CountryCode.values())
        {
            ...
            {
                cotry = stripNonAlphaNumeric(cotry);                
    ...
    /**
     * Get a CountryCode that corresponds to a given <a href="http://en.wikipedia.org/wiki/ISO_3166-1_numeric">ISO
    ...
    public static boolean isInUS9CodeZone(String value)
    {
        ...
        else if (code == CountryCode.AM || code == CountryCode.PR || code == CountryCode.AS || code == CountryCode.MP
                || code == CountryCode.VI || code == CountryCode.FM || code == CountryCode.MH || code == CountryCode.PW)
        {
            return true;
        }
        else
